...
const ContentCard: React.FC<{ item: ContentItem, onOpenVideo?: (u: string, p: string, t?: string) => void, onOpenNote?: (item: ContentItem) => void }> = ({ item, onOpenVideo, onOpenNote }) => {
...
const MasonryGrid = ({ items, onOpenVideo, onOpenNote }: { items: ContentItem[], onOpenVideo?: (u: string, p: string, t?: string) => void, onOpenNote?: (item: ContentItem) => void }) => {
  ...
  return (
    <div className="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-6 space-y-6">
      {items.map(item => (
        <ContentCard key={item.id} item={item} onOpenVideo={onOpenVideo} onOpenNote={onOpenNote} />
      ))}
    </div>
  );
};
  ...
  return (
    <div className="min-h-screen pb-20 relative">
      ...
      <main className="max-w-7xl mx-auto px-4">
        ...
        <MasonryGrid items={displayedItems} onOpenVideo={(u,p,t) => { setModalVideo({url:u, platform:p, title:t}); setIsVideoModalOpen(true); }} onOpenNote={(it) => { setModalNote(it); setIsNoteModalOpen(true); }} />
      </main>
